...
export function BasicTable(indicators: { [key: string]: any }) {
    return (
...
export function IndicatorSummary(indicators: { [key: string]: any }) {return (
  <div
    dangerouslySetInnerHTML={{__html: BasicTable(indicators)}}
  />
);
