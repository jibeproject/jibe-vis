    ...
    return (
      ...
      <Flex direction={{ base: 'column', large: 'row'}}>
        ...
        <View 
          ...
          <li>Scroll horizontally through usage examples, features and measures requested, artifacts and experiences that users want to get out of the tool, spatial scales and infrastructures of interest, and how users would like to interact with the tool.</li>
          <li>Number of mentions of a theme is represented by a proportionately scaled circle.</li>
          <li>Hover over a theme for additional context, displaying associated and intersecting themes.</li>
          <li>While the number of mentions may provide a crude metric of priority, many concepts are inter-related and a lesser-mentioned aspect may be an important consideration for a concept mentioned elsewhere.</li>
        </View>
        </Flex>    
        <Box marginTop={4}>
