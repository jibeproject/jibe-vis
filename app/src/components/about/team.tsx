...
const team = [
    ...
    {'name': 'Dr Carl Higgs', 'role': 'Lead Developer / Research Software Engineer / Investigator', 'institution': 'RMIT University'},
    {'name': 'Atefeh Soleimani Roudi', 'role': 'Investigator', 'institution': 'RMIT University'},
