...
import { Section } from '../section';
  ...
  export const timeline_data = {
    nodes: [
        ...
        { label: "Prioritisation", group: 'Prototype', date: "2024-07-01", end: "", offset: -15, anchor: 'start' },
        { label: "", group: 'Development', date: "2024-07-09", end: "2025-02-17", offset: 5, anchor: 'start' },
        { label: "Feature implementation (ongoing)", group: 'Development', date: "2024-10-25", end: "", offset: -30, anchor: 'end' },
        { label: "Workshop 2", group: 'Development', date: "2024-11-14", end: "", offset: -45, anchor: 'end' },
        { label: "Workshop 3", group: 'Development', date: "2024-12-01", end: "", offset: -60, anchor: 'start' },
        { label: "Documentation and wrap up", group: 'Completion', date: "2025-02-17", end: "2025-04-30", offset: 0, anchor: 'middle' },
