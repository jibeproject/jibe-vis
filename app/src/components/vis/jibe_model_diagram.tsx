  ...
  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
      ...
      <g>
          ...
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-outputs"/><text id="jibe-bold" transform="translate(1137.35 33)">Mobility Outputs</text></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(1155.69 119)">Travel times {getJibeTitle("Travel times")}</text></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(1174.56 166)">Stress{getJibeTitle("Cycling stress")}</text></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(1157.2 71)">Congestion{getJibeTitle("Congestion level")}</text></g>
          ...
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-outputs"/><text id="jibe-bold" transform="translate(22.1062 344)">Health Outputs {getJibeTitle("Health outputs")}</text></g>
          <g id="svg-element-wrapper"><path
          ...
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-outputs"/><text id="jibe-bold" transform="translate(1144.9 323)">Environmental{getJibeTitle("Environmental outputs")}</text><text id="jibe-bold" transform="translate(1168.26 342)">Outputs{getJibeTitle("Environmental outputs")}</text></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(1180.34 575)">Noise</text></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(1164.84 443)">Emissions</text></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(1174.76 368)">Carbon</text><text id="jibe" transform="translate(1168.94 387)">Footprint</text></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(1158.12 509)">Air pollutant</text></g>
          <g id="svg-element-wrapper"><path
          ...
          <g id="svg-element-wrapper"><path
              ...
              fill="#156082" transform="matrix(-1 1.22465e-16 1.22465e-16 1 1139.76 503)" /></g>
          <g id="svg-element-wrapper"><path
              ...
              fill="url(#fill0)" fillRule="evenodd" /><text id="jibe-bold" transform="translate(500.693 263)">Agent-based transport and health model{getJibeTitle("Agent-based transport model")}</text></g>
          <g id="svg-element-wrapper"><path
              ...
              fontWeight="700" fontSize="16" transform="translate(702.041 453)">Health Modelling{getJibeTitle("Health impact models")}</text></g>
          <g id="svg-element-wrapper"><path
              ...
              fill="#E59EDD" fillRule="evenodd" fillOpacity="0.301961" /><text id="jibe-bold" transform="translate(691.388 295)">Transport modelling</text></g>
          ...
          <g id="svg-element-wrapper"><path
              ...
              fill="#156082" transform="matrix(1.83697e-16 1 1 -1.83697e-16 593 535)" /></g>
          <g id="svg-element-wrapper"><path
          ...
          <g id="svg-element-wrapper"><path
              ...
              fill="#156082" transform="matrix(1.83697e-16 1 1 -1.83697e-16 764 535)" /></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-demographics"/><text id="jibe-bold" transform="translate(280 346)">Demographic models{getJibeTitle("Demographic model")}</text></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(575.438 335)">Individual travel{getJibeTitle("Travel behaviour model")}</text><text id="jibe" transform="translate(596.118 354)">behaviors{getJibeTitle("Travel behaviour model")}</text></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(848.785 326)">Agent-based{getJibeTitle("Agent-based transport model")}</text><text id="jibe" transform="translate(822.705 345)">transport simulation{getJibeTitle("Agent-based transport model")}</text><text id="jibe" transform="translate(860.565 364)">(MATSim){getJibeTitle("MATSim")}</text></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(714.125 605)">Health Models{getJibeTitle("State transitions model")}</text></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(899.068 499)">Exposures{getJibeTitle("Health exposures")}</text><text id="jibe" transform="translate(909.541 518)">Models{getJibeTitle("Exposure simulations")}</text></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(717.588 509)">Injury Models{getJibeTitle("Health impact models")}</text></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(537.968 499)">Physical activity{getJibeTitle("Physical activity")}</text><text id="jibe" transform="translate(567.041 518)">models{getJibeTitle("Physical activity")}</text></g>
          <g id="svg-element-wrapper"><path
              ...
              fontWeight="700" fontSize="16" transform="translate(576.507 681)">Equity outcomes{getJibeTitle("Spatial equity")}</text></g>
          <g id="svg-element-wrapper"><path
              ...
              fill="#FBE3D6" fillRule="evenodd" fillOpacity="0.301961" /><text id="jibe-bold" transform="translate(535.54 26)">Scenario development{getJibeTitle("Transport scenario")}</text></g>
          <g id="svg-element-wrapper"><path
          ...
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(664.376 164)">Transport networks:{getJibeTitle("Transport network")}</text><text id="jibe" transform="translate(666.083 183)">vehicles, walk, bike{getJibeTitle("Transport network")}</text></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(465.65 169)">Land use{getJibeTitle("Land use database")}</text></g>
          <g id="svg-element-wrapper"><path
          ...
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-outputs"/><text id="jibe-bold" transform="translate(12.3574 33)">Built environment{getJibeTitle("Built environment outputs")}</text><text id="jibe-bold" transform="translate(47.4107 52)">Outputs{getJibeTitle("Built environment outputs")}</text></g>
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(51.0174 181)">Cycling{getJibeTitle("Cycling infrastructure")}</text><text id="jibe" transform="translate(29.4174 200)">infrastructure{getJibeTitle("Cycling infrastructure")}</text></g>
          <g id="svg-element-wrapper"><path
          ...
          <g id="svg-element-wrapper"><path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(58.1796 241)">Local</text><text id="jibe" transform="translate(33.8996 260)">accessibility{getJibeTitle("Accessibility analysis")}</text></g>
          <g id="svg-element-wrapper"><path
