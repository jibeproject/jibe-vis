  ...
  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
      ...
      <g>
          ...
          <path
              ...
              id="jibe-outputs"/><text id="jibe-bold" transform="translate(1137.35 33)">Mobility Outputs</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(1155.69 119)">Travel times {getJibeTitle("Travel times")}</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(1174.56 166)">Stress{getJibeTitle("Cycling stress")}</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(1157.2 71)">Congestion{getJibeTitle("Congestion level")}</text>
          ...
          <path
              ...
              id="jibe-outputs"/><text id="jibe-bold" transform="translate(22.1062 344)">Health Outputs {getJibeTitle("Health outputs")}</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(53.1628 380)">Deaths</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(45.3462 488)">Life years</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(32.5262 597)">Quality of life</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(46.0929 434)">Diseases</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(65.5262 533)">Life</text><text id="jibe" transform="translate(38.5129 552)">expectancy</text>
          <path
          ...
          <path
              ...
              id="jibe-outputs"/><text id="jibe-bold" transform="translate(1144.9 323)">Environmental{getJibeTitle("Environmental outputs")}</text><text id="jibe-bold" transform="translate(1168.26 342)">Outputs{getJibeTitle("Environmental outputs")}</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(1180.34 575)">Noise</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(1164.84 443)">Emissions</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(1174.76 368)">Carbon</text><text id="jibe" transform="translate(1168.94 387)">Footprint</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(1158.12 509)">Air pollutant</text>
          <path
              id="jibe-arrow" d="M1139.76 570.49 1083.38 570.49 1083.38 537 1084.38 538 1035.67 538 1035.67 536 1085.38 536 1085.38 569.49 1084.38 568.49 1139.76 568.49ZM1037 541 1029 537 1037 533Z"
              fill="#156082" />
          <path
          ...
          <path
              ...
              fill="url(#fill0)" fillRule="evenodd" /><text id="jibe-bold" transform="translate(500.693 263)">Agent-based transport and health model{getJibeTitle("Agent-based transport model")}</text>
          <path
              ...
              fontWeight="700" fontSize="16" transform="translate(702.041 453)">Health Modelling{getJibeTitle("Health impact models")}</text>
          <path
              ...
              fill="#E59EDD" fillRule="evenodd" fillOpacity="0.301961" /><text id="jibe-bold" transform="translate(691.388 295)">Transport modelling</text>
          <path id="jibe-arrow" d="M707 338 799.627 338 799.627 340 707 340ZM798.293 335 806.293 339 798.293 343Z" fill="#084F6A" />
          <path
          ...
          <path id="jibe-arrow" d="M765 391 765 420.605 763 420.605 763 391ZM768 419.272 764 427.272 760 419.272Z" fill="#156082" />
          <path
          ...
          <path
              id="jibe-arrow" d="M936.5 535 936.5 551.821 765 551.821 766 550.821 766 559.976 764 559.976 764 549.821 935.5 549.821 934.5 550.821 934.5 535ZM769 558.642 765 566.642 761 558.642Z"
              fill="#156082" />
          <path
          ...
          <path
              ...
              id="jibe-demographics"/><text id="jibe-bold" transform="translate(280 346)">Demographic models{getJibeTitle("Demographic model")}</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(575.438 335)">Individual travel{getJibeTitle("Travel behaviour model")}</text><text id="jibe" transform="translate(596.118 354)">behaviors{getJibeTitle("Travel behaviour model")}</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(848.785 326)">Agent-based{getJibeTitle("Agent-based transport model")}</text><text id="jibe" transform="translate(822.705 345)">transport simulation{getJibeTitle("Agent-based transport model")}</text><text id="jibe" transform="translate(860.565 364)">(MATSim){getJibeTitle("MATSim")}</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(714.125 605)">Health Models{getJibeTitle("State transitions model")}</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(899.068 499)">Exposures{getJibeTitle("Health exposures")}</text><text id="jibe" transform="translate(909.541 518)">Models{getJibeTitle("Exposure simulations")}</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(717.588 509)">Injury Models{getJibeTitle("Health impact models")}</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(537.968 499)">Physical activity{getJibeTitle("Physical activity")}</text><text id="jibe" transform="translate(567.041 518)">models{getJibeTitle("Physical activity")}</text>
          <path
              ...
              fontWeight="700" fontSize="16" transform="translate(576.507 681)">Equity outcomes{getJibeTitle("Spatial equity")}</text>
          <path
              ...
              fill="#FBE3D6" fillRule="evenodd" fillOpacity="0.301961" /><text id="jibe-bold" transform="translate(535.54 26)">Scenario development{getJibeTitle("Transport scenario")}</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(681.822 61)">Policy analysis</text>
          <path
          ...
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(424.64 60)">Policy advisory group</text>
          <path
              ...
              fill="#CAEEFB" fillRule="evenodd" fillOpacity="0.301961" /><text id="jibe-bold" transform="translate(494.184 134)">Built environment spatial analysis</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(664.376 164)">Transport networks:{getJibeTitle("Transport network")}</text><text id="jibe" transform="translate(666.083 183)">vehicles, walk, bike{getJibeTitle("Transport network")}</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(465.65 169)">Land use{getJibeTitle("Land use database")}</text>
          <path
          ...
          <path id="jibe-arrow" d="M343.146 157 164.667 157 164.667 155 343.146 155ZM166 160 158 156 166 152Z" fill="#156082" />
          <path
              ...
              id="jibe-outputs"/><text id="jibe-bold" transform="translate(12.3574 33)">Built environment{getJibeTitle("Built environment outputs")}</text><text id="jibe-bold" transform="translate(47.4107 52)">Outputs{getJibeTitle("Built environment outputs")}</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(51.0174 181)">Cycling{getJibeTitle("Cycling infrastructure")}</text><text id="jibe" transform="translate(29.4174 200)">infrastructure{getJibeTitle("Cycling infrastructure")}</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(34.1741 83)">JIBE network</text><text id="jibe" transform="translate(63.0941 102)">with</text><text id="jibe" transform="translate(27.8607 121)">environmental</text><text id="jibe" transform="translate(42.0741 140)">exposures</text>
          <path
              ...
              id="jibe-specific-outputs"/><text id="jibe" transform="translate(58.1796 241)">Local</text><text id="jibe" transform="translate(33.8996 260)">accessibility{getJibeTitle("Accessibility analysis")}</text>
          <path
