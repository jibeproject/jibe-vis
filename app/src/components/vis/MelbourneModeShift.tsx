    ...
    try {
      ...
      const mapData = (result: any[]): DistributionData[] => {
        return result.map((row: any) => ({
          ...
          pct_walk_mins_week_p5: row.pct_walk_mins_week_p5 ?? 0,
          pct_walk_mins_week_p25: row.pct_walk_mins_week_p25 ?? 0,
          pct_walk_mins_week_p50: row.pct_walk_mins_week_p50 ?? 0,
          pct_walk_mins_week_p75: row.pct_walk_mins_week_p75 ?? 0,
          pct_walk_mins_week_p95: row.pct_walk_mins_week_p95 ?? 0,
          pct_bike_mins_week_p5: row.pct_bike_mins_week_p5 ?? 0,
          pct_bike_mins_week_p25: row.pct_bike_mins_week_p25 ?? 0,
          pct_bike_mins_week_p50: row.pct_bike_mins_week_p50 ?? 0,
          pct_bike_mins_week_p75: row.pct_bike_mins_week_p75 ?? 0,
          pct_bike_mins_week_p95: row.pct_bike_mins_week_p95 ?? 0,
          pct_car_mins_week_p5: row.pct_car_mins_week_p5 ?? 0,
          pct_car_mins_week_p25: row.pct_car_mins_week_p25 ?? 0,
          pct_car_mins_week_p50: row.pct_car_mins_week_p50 ?? 0,
          pct_car_mins_week_p75: row.pct_car_mins_week_p75 ?? 0,
          pct_car_mins_week_p95: row.pct_car_mins_week_p95 ?? 0,
          pct_pt_mins_week_p5: row.pct_pt_mins_week_p5 ?? 0,
          pct_pt_mins_week_p25: row.pct_pt_mins_week_p25 ?? 0,
          pct_pt_mins_week_p50: row.pct_pt_mins_week_p50 ?? 0,
          pct_pt_mins_week_p75: row.pct_pt_mins_week_p75 ?? 0,
          pct_pt_mins_week_p95: row.pct_pt_mins_week_p95 ?? 0,
          walk_share: row.walk_share ?? 0,
          bike_share: row.bike_share ?? 0,
          car_share: row.car_share ?? 0,
          pt_share: row.pt_share ?? 0,
        }));
      };
